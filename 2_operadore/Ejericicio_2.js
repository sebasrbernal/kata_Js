...
if(pregunta==='si'){
    ...
    console.log('No entedi tu respuesta')
}
...
// Carrera 6 meses
// Master: 12 meses
let tipoDeCurso = prompt('¿Cual es el curso que estas tomando Course, Carrera,Master?')
let tipoDeBeca = prompt('¿Cuentas con alguna beca Facebook, Google, Jesua o no?' )

if (tipoDeCurso === 'Course'){
    if(tipoDeBeca === 'Facebook' ){
        console.log('El costo del curso es ' + 4999*.80*2)
    }else if(tipoDeBeca === 'Google'){
        console.log('El costo del curso es ' + 4999*.15*2)
    }else if (tipoDeBeca==='Jesua') {
        console.log('El costo del curso es ' + 4999*.50*2)
    }else if(tipoDeBeca==='no'){
        console.log('El costo del curso es ' + 4999*2)
    }
} 
if (tipoDeCurso === 'Carrera'){
    if(tipoDeBeca === 'Facebook' ){
        console.log('El costo del curso es ' + 3999*.80*6)
    }else if(tipoDeBeca === 'Google'){
        console.log('El costo del curso es ' + 3999*.15*6)
    }else if (tipoDeBeca==='Jesua') {
        console.log('El costo del curso es ' + 3999*.50*6)
    }else if(tipoDeBeca==='no'){
        console.log('El costo del curso es ' + 3999*6)
    }
}
if (tipoDeCurso === 'Master'){
    if(tipoDeBeca === 'Facebook' ){
        console.log('El costo del curso es ' + 2999*.80*12)
    }else if(tipoDeBeca === 'Google'){
        console.log('El costo del curso es ' + 2999*.15*12)
    }else if (tipoDeBeca==='Jesua') {
        console.log('El costo del curso es ' + 2999*.50*12)
    }else if(tipoDeBeca==='no'){
        console.log('El costo del curso es ' + 2999*12)
    }
}
